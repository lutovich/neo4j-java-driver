...
public interface Session extends Resource, StatementRunner
{
     ...
     *
     * @param work the {@link TransactionWork} to be executed in a new read transaction.
     * @param <T> the return type of the given unit of work.
     * @param <U> the exception type of the given unit of work.
     * @return a result as returned by the given unit of work.
     */
    <T, U extends Throwable> T readTransaction( TransactionWork<T,U> work ) throws U;

    /**
     * Execute given unit of work in a {@link AccessMode#WRITE write} transaction.
     *
     * @param work the {@link TransactionWork} to be executed in a new write transaction.
     * @param <T> the return type of the given unit of work.
     * @param <U> the exception type of the given unit of work.
     * @return a result as returned by the given unit of work.
     */
    <T, U extends Throwable> T writeTransaction( TransactionWork<T,U> work ) throws U;
