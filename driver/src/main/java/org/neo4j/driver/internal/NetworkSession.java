...
public class NetworkSession implements Session, SessionResourcesHandler
{
    ...
    @Override
    public <T, U extends Throwable> T readTransaction( TransactionWork<T,U> work ) throws U
    {
        return transaction( AccessMode.READ, work );
    }

    @Override
    public <T, U extends Throwable> T writeTransaction( TransactionWork<T,U> work ) throws U
    {
    ...
    private synchronized <T, U extends Throwable> T transaction( AccessMode mode, TransactionWork<T,U> work ) throws U
    {
