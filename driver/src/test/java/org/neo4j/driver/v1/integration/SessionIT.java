...
public class SessionIT
{
    ...
    public void writeTxDoesNotCommitWhenMarkedForFailure()
    {
        ...
        {
            int answer = session.writeTransaction( new TransactionWork<Integer,RuntimeException>()
            {
                @Override
    ...
    private void testExecuteReadTx( AccessMode sessionMode )
    {
        ...
        {
            Set<String> names = session.readTransaction( new TransactionWork<Set<String>,RuntimeException>()
            {
                @Override
    ...
    private void testExecuteWriteTx( AccessMode sessionMode )
    {
        ...
        try ( Session session = driver.session( sessionMode ) )
        {
            String material = session.writeTransaction( new TransactionWork<String,RuntimeException>()
            {
                @Override
    ...
    private void testTxRollbackWhenFunctionThrows( AccessMode sessionMode )
    {
        ...
        try ( Session session = driver.session( sessionMode ) )
        {
            try
            {
                session.writeTransaction( new TransactionWork<Void,RuntimeException>()
                {
                    @Override
    ...
    private static class ThrowingWork implements TransactionWork<Record,RuntimeException>
    {
        final String query;
        final int failures;
